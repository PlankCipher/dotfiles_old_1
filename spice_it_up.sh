...
EOF
  ...
  yay -S hyprland-git xdg-desktop-portal-hyprland-git swaylock-effects swaybg wl-clipboard brightnessctl lxsession-gtk3 xf86-video-amdgpu dunst libnotify qt5-wayland qt6-wayland gnome-themes-extra bibata-cursor-theme swayidle wlrctl-git
